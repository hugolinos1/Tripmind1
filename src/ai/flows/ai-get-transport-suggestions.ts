...
3.  **For each option, provide details.** Include estimated duration, cost, and a brief description in French covering ease of use, convenience, and any tips (e.g., "Idéal pour voir la ville", "Le plus rapide en heure de pointe", "Nécessite une carte de transport").
